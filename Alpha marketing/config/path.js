...
module.exports = {
  ...
  resources: {
    src: [`${srcFolder}/resources/**`, `!${srcFolder}/resources/fonts/**`],
  ...
  font: {
    src: srcFolder + "/resources/fonts/*.{eot,ttf,otf,otc,ttc,woff,woff2,svg}",
    watch: srcFolder + "/resources/fonts/**/*.{eot,ttf,otf,otc,ttc,woff,woff2,svg}",
    destBuild: buildFolder + "/fonts",
  },
};
